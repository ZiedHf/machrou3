...
/**
 * AssocDepartementsUsersFixture
 *
 */
class AssocDepartementsUsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'FK_ADU_users_idx' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_ADU_departements' => ['type' => 'foreign', 'columns' => ['departement_id'], 'references' => ['departements', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'FK_ADU_users' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
