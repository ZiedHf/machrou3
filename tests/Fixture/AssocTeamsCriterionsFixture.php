...
/**
 * AssocTeamsCriterionsFixture
 *
 */
class AssocTeamsCriterionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_teams_criterions_idx' => ['type' => 'index', 'columns' => ['team_id'], 'length' => []],
            'FK_ATC_criterions_idx' => ['type' => 'index', 'columns' => ['criterion_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_ATC_criterions' => ['type' => 'foreign', 'columns' => ['criterion_id'], 'references' => ['criterions', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'FK_teams_criterions' => ['type' => 'foreign', 'columns' => ['team_id'], 'references' => ['teams', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
