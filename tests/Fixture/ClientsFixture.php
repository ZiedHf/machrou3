...
class ClientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'lastName' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-11-15 08:56:24',
            'modified' => '2016-11-15 08:56:24',
            'created_by' => 1,
            'modified_by' => 1
        ],
    ];
