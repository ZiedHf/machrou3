...
class TeamsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'path_image' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
            'FK_teams_departements_idx' => ['type' => 'index', 'columns' => ['departement_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_teams_departements' => ['type' => 'foreign', 'columns' => ['departement_id'], 'references' => ['departements', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'departement_id' => 1,
            'created' => '2016-09-27 15:57:16',
            'modified' => '2016-09-27 15:57:16',
            'created_by' => 1,
            'modified_by' => 1,
